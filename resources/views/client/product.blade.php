    ...
    <div class="container">
        ...
        <div class="flex-w flex-sb-m p-b-52">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                @if($menu->parent_id != 0)
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{$menu->id}}">
                    {{ $menu->name }}
                </button>
                @endif
                @endforeach
        ...
        <div class="row isotope-grid">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$product->menu_id}}" data-product='@json($product)'>
                <!-- Block2 -->
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('storage/uploads/'.$product->thumb) }}" alt="{{$product->name}}" width="200" height="400">
        ...
        <div class="flex-c-m flex-w w-full p-t-45">
            <center><button class="codepro-btn codepro-btn-5 hover-border-11" target="blank" title="load more" ><span>load more</span></button></center>
        </div>
    </div>
</section>
