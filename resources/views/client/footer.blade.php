        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    ...
                    @if($menu->parent_id == 0)
                    <li class="p-b-10">
                        <a href="#" class="stext-107 cl10 hov-cl1 trans-04">{{ $menu->name }}</a>
                    </li>
                    @endif
                    @endforeach
                </ul>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form action="{{route('client.feedback')}}" method="post">
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl10" type="text" name="email" placeholder="email@example.com">
