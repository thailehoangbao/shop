...
@section('content')
<h3 style="color: #cc3a3d; padding-left: 18px;">What do you think? Send your idea..</h3>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="card-body">
        <div class="form-group">
            <label for="title">Tiêu đề bài post <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            <h5 style="margin-top:12px; color: #cc3a3d">Nội dung 1</h5>
            <div class="form-group">
                <label for="sub_title_1">Tiêu đề<span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label for="content_1">Nội dung<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            <h5 style="margin-top:12px; color: #cc3a3d">Nội dung 2</h5>
            <div class="form-group">
        ...
        <div class="form-group">
            <h5 style="margin-top:12px; color: #cc3a3d">Nội dung 3</h5>
            <div class="form-group">
